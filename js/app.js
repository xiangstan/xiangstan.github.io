...
return val},initblog:function(){const that=this;that.Ajax({data:!1,url:"/data.json"},function(result){if(typeof result.posts!=="undefined"){that.posts=result.posts}})},},mounted(){const init="init"+this.curPage;if(typeof init!=="undefined"){this[init]()}},template:"#temp-app"});
